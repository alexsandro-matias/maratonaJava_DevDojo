...
public class ClienteTest
{
	public static void main(String[] args)
	{
		...
		// Cliente cliente2 = new Cliente(10, "Anna"); // Possível já que pode ser
		...
		//
		// O único atributo válido é um atributo TIPOCLIENTE, diferente disso, dará um
		// erro de compilação. Por isso, o código se torna mais seguro, já que não teria
