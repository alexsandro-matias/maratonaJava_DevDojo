...
public class FileWriterReaderTest
{
	public static void main(String[] args)
	{
		...
		try
		{
			...
			arquivoSalvo.write("Uma linha no arquivo");
			System.out.println("Arquivo salvo até aqui");
		}
		catch (IOException e)
		{
		...
		// linha2
		// ");
		// // Toda vez que trabalhamos com um arquivo, estamos trabalhado com
		// Buffer.
		// Que é
		// // um recurso do sistema operacional que não temos a certeza que tudo
		// ocorreu
		// da
		// forma correta, chamados de Steam que são vários Bytes. Para garantir
		// que
		// saia
		...
		// // Agora, caso queira incluir no final do arquivo, devemos adicionar
		// no
		// // construtor o parâmetro booleano chamado append, deixando como true
		// o
		// segundo
		...
		// e.printStackTrace();
		// }
		// // Uma série de classes ou interfaces são chamandas quando se
		// trabalha com
		// // arquivos.
		// Usando Try with resources
		//
		// try (FileWriter arquivoSalvo = new FileWriter(file, true); FileReader
		// arquivoLido = new FileReader(file);)
		// {
		// arquivoSalvo.write(" Escrevendo uma mensagem no arquivo\npulando uma
		// linha2 ");
		// arquivoSalvo.flush();
		...
		// e.printStackTrace();
		// }
		// Uma série de classes ou interfaces são chamandas quando se trabalha
		// com
		// arquivos
	}
}
