...
public class polimorfismoTest
{
	public static void main(String[] args)
	{
		...
		// referenciando. E que sempre quem irá executar os métodos são os objetos.
		// As classes somente dizem quais os métodos e atributos que podem ser
		// chamados.
		// System.out.println(funcionario.getSalario());
		// Passando um método mais genérico:
		Funcionario funcionario = vendedor; // o objeto funcionário está referenciando o mesmo objeto que vendedor está
		relatorio.relatorioPagamentoGenerico(gerente);
		// Quando descomentarmos a linha de baixo, apresentará o seguinte erro em tempo
		// de execução:
		// Gerando relatório de pagamento:
		// Nome do Funcionário: Yuri
		// Salário: R$ 2100.0
		// Exception in thread "main" java.lang.ClassCastException:
		// br.com.abc.javacore.parte15_polimorfismo.classes.Vendedor cannot be cast to
