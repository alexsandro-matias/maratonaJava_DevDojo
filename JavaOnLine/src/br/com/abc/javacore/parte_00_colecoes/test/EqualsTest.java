...
public class EqualsTest
{
	public static void main(String[] args)
	{
		...
		// // retorna true, uma vez que as Strings ficam
		// // armazenadas no pools de
		...
		// ->
		// // estamos colocando o objeto no heap e eles estão em locais
		// diferentes
		...
		//
		// O método equals() é definido na classe object e essa comparação é
		// muito genérica. Se faz necessário, implementar um método mais
		// específico usando sobrescrita de método.
	}
}