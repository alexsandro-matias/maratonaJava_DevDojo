...
public class Estudante
{
	...
	// Caso seja necessário alterar a regra de negócio e ser inserido o campo de
	// data de matrícula do Estudante,
	// teria que ser adicionado ao construtor. Uma das formas é através da
	// sobrecarga do construtor:
	// public Estudante(String matricula, String nome, double[] notas, String
	// dataMatricula) {
	// this.matricula = matricula;
	// this.nome = nome;
	// this.notas = notas;
	// this.dataMatricula;
	// }
	// Porém a abordagem é uma péssima implementação, devido à repetição de
	// código, então,
	// em Java é possível usar um construtor para construir outro através da
